...
Array.prototype.change_obj_with_key = function (key, val, new_obj) {
  var result = this.in_obj_with_key(key, val);
...
Array.prototype.get_obj = function (key, val) {
 ...
 * */
Array.prototype.all_exist = function (key) {
...
var _screen = __webpack_require__(333);
...
var _py = __webpack_require__(330);

var _window_lib = __webpack_require__(331);

var _vue_lib = __webpack_require__(332);
...
exports.default = {
  ...
  install_vue: _vue_lib.install_vue
};
    ...
    vm.$watch(attr, function (val) {
      ...
      try {
        for (var _iterator4 = self.get_attr_data[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          ...
          if (_item.key === key) {
            if (_item.attr === null) self.equal_val(_item.vm, attr, val);else self.equal_val(_item.vm, _item.attr, val);
          }
        }
      } catch (err) {
  ...
  trigger: function trigger(key) {
    ...
    try {
      for (var _iterator7 = this.data[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
        ...
        if (item.key === key) {
          item.fn.apply(item, _toConsumableArray(arg));
        }
      }
    } catch (err) {
...
var date_to_str = function date_to_str(date) {
...
exports.install_vue = install_vue;
...
function install_vue(Vue) {
  var MyPlugin = {};
  MyPlugin.install = function (Vue, options) {
    Vue.prototype.$dict_get = dict_get;
    Vue.mixin(_mixin2.default.screen);
...
exports.default = {
  ...
  computed: {
    window_size: function window_size() {
      var w = parseInt(this.window__width);
      if (w < 600) {
        return 'xs';
      } else if (w < 960 && w >= 600) {
        return 'sm';
  ...
  mounted: function mounted() {
    ...
    $(window).on("resize", function () {
      _this.window__width = window.innerWidth;
    });
  }
};
